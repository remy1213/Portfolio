    ...
    >
      ...
      >
        ...
        >
          ...
          <a href="/" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-2xl text-white"}`}>remywilkins</span>
          </a>
          ...
          {/* Desktop CTA - removed for portfolio */}
      ...
      >
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          {/* Bottom CTAs removed for portfolio */}
